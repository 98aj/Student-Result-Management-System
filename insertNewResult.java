...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                st.executeUpdate("insert into result (rollno,phy,chm,maths,ele,eng) values('"+rollno+"','"+phy+"','"+chm+"','"+maths+"','"+ele+"','"+eng+"')");
                JOptionPane.showMessageDialog(null, "Successfully Updated");
                setVisible(false);
                new insertNewResult().setVisible(true);
            }
            else{
                JOptionPane.showMessageDialog(null, "Roll No Does Not Extist");
                setVisible(false);
                new insertNewResult().setVisible(true);
            }
